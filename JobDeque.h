...
typedef struct dq_node_st {
  job             payload;     // customer-supplied payload
...
void Deque_Push_Front(Deque *deque, job payload);
...
// - true on success.
bool Deque_Pop_Front(Deque *deque, job *payload_ptr);
...
// - false on failure (eg, the deque is empty).
// - true on success.
bool Deque_Peek_Front(Deque *deque, job *payload_ptr);
...
void Deque_Push_Back(Deque *deque, job payload);
...
// - false: on failure (eg, the deque is empty).
// - true: on success.
bool Deque_Pop_Back(Deque *deque, job* payload_ptr);
...
// - false on failure (eg, the deque is empty).
// - true on success.
bool Deque_Peek_Back(Deque *deque, job *payload_ptr);
...
DQIterator* DQIterator_Allocate(Deque *deque);
...
void DQIterator_Get(DQIterator *iter, job *payload);
